...
urlpatterns = [
    ...
    path('investor/kyc/', views.investor_kyc, name='investor-kyc'),
    path('investor/kyc/submit/', views.investor_kyc_submit, name='investor-kyc-submit'),
    path('investor/kyc/upload/', views.investor_kyc_upload, name='investor-kyc-upload'),
    path('investor/kyc/documents/<int:doc_id>/', views.investor_kyc_document, name='investor-kyc-document'),
